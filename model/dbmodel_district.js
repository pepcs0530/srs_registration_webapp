function dbmodel_district(){
    ...
    this.getData = function(id,callback) {
        var sql = "SELECT * FROM ctl_district  ORDER BY DISTRICT_PK ASC ";
        
        if(id>0) sql = "SELECT * FROM ctl_district  WHERE AMPHUR_PK = "+id
...
module.exports = new dbmodel_district();