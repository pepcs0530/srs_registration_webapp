function dbmodel_amphur(){
    ...
    this.getData = function(id,callback) {
        var sql = "SELECT * FROM ctl_amphur  ORDER BY AMPHUR_PK ASC ";
        
        if(id>0) sql = "SELECT * FROM ctl_amphur  WHERE PROVINCE_PK = "+id
...
module.exports = new dbmodel_amphur();